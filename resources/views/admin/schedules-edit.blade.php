<x-layouts::app :title="__('Edit Jadwal')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}" class="grid gap-4 rounded-xl border border-neutral-200 p-4 dark:border-neutral-700">
            @csrf
            @method('PUT')
            ...
            <flux:field>
                ...
                >
                    ...
                    <div class="relative mb-2">
                        <input x-model="query" id="participant-search-edit" type="search" placeholder="Cari nama atau NIM..." class="w-full rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 dark:border-neutral-700 dark:bg-neutral-900">
                    </div>
