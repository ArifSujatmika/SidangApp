<x-layouts::app :title="__('Lengkapi Laporan')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="max-w-lg rounded-xl border border-yellow-100 bg-yellow-50/40 p-4 dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <form method="POST" action="{{ route('submissions.update', $submission) }}" enctype="multipart/form-data" class="max-w-lg space-y-4">
            ...
            <button type="submit" class="rounded-lg bg-yellow-500 px-6 py-2 text-sm font-medium text-white hover:bg-yellow-600">Simpan Laporan</button>
        </form>
    </div>
</x-layouts::app>
